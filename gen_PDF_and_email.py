...
def process_data(data):
  ...
  for item in data:
    ...
    #Handle most popular cars
    if item['car']['car_year'] not in max_popular_car.keys():
      max_popular_car[item['car']['car_year']] = item['total_sales']
    else:
      max_popular_car[item['car']['car_year']] += item['total_sales']

  max_popular_car = sorted(max_popular_car.items(), key=operator.itemgetter(1),$
  year, total_sales = max_popular_car[0]
  
 summary = [
    "The {} generated the most revenue: ${}".format(
      format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(max_sales['Car_name'], max_sales['to$
